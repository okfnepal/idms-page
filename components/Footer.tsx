...
const footerSocials = [
    { title: "About", favIcon: faUsers, href: "/about-okfnepal"},
            ...
            <div className="relative  mx-auto w-full max-w-screen-xl pt-16 px-8">
                ...
                <div className="flex-1 flex flex-col md:flex-row justify-between py-4">
                    <p className="text-sm md:text-base pb-2 md:pb-0 w-full md:w-4/6">Content on this site, made by &nbsp;
                        <Link href='https://oknp.org/'><span className='underline'>Open Knowledge Foundation Nepal</span></Link>, is licensed under a <Link href="https://creativecommons.org/licenses/by/4.0/"><span className='underline'>Creative Commons Attribution 4.0 International License.</span></Link>
                    </p>
