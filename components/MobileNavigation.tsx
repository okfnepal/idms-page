...
import { Fragment, useEffect, useState, SVGAttributes } from "react";
...
function MenuIcon(props: SVGAttributes<SVGSVGElement>) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
...
function CloseIcon(props: SVGAttributes<SVGSVGElement>) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
